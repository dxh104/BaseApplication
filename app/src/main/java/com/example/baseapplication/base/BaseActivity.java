...
import com.example.baseapplication.manager.ActivityManager;
import com.example.baseapplication.util.AppUtil;
import com.example.baseapplication.util.LoadingDialogUtil;
import com.example.baseapplication.util.ToastUtil;
 ...
 */
//BaseActivity负责创建创建P,实现基类接口 (V层)  ----->V用于限定子类传给Presenter的V接口类型
public abstract class BaseActivity<V extends BaseContract.IView, P extends BasePresenter> extends RxAppCompatActivity implements BaseContract.IView {
    //管理所有Activity
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (mPresenter != null && getIView() != null)
            mPresenter.attach(mProvider, this, getIView());//附加视图
        //开始进行初始化
        initView();
        initData();
