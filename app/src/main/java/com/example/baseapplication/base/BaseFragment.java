...
import com.example.baseapplication.manager.FragmentManager;
...
public abstract class BaseFragment<M extends BaseContract.IModel, V extends BaseContract.IView, P extends BasePresenter<M, V>> extends NaviFragment implements BaseContract.IView {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (mPresenter != null && getFragmentIView() != null) {
            mPresenter.attach(mProvider, mContext, getFragmentIView());//附加视图
        }
        return mContentView;
    }
     ...
     * @return
     */
    protected abstract V getFragmentIView();
